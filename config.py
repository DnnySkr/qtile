# Dracula Themed Qtile config - Dnny
...
# SUPER + SHIFT KEYS
    ...
    Key([mod, "shift"], "d", lazy.spawn("dmenu_run -i -b -p 'run:' -nb '#282a36' -nf '#bd93f9' -sb '#bd93f9' -sf '#44475a' -fn 'Fira Mono:pixelsize=14'")),
...
layouts = [
    layout.MonadTall(margin = 5, border_width=1, border_focus="#bd93f9", border_normal="#4c566a"),
    layout.MonadWide(margin = 5, border_width=1, border_focus="#bd93f9", border_normal="#4c566a"),
...
def init_colors():
    return [["#282a36", "#282a36"], # color 0 - Dracula - black BG
            ["#44475a", "#44475a"], # color 1 - Dracula grey 1 - current line
            ["#44475a", "#44475a"], # color 2 - Dracula grey 2 - selection
            ["#f8f8f2", "#f8f8f2"], # color 3 - Dracula white - foreground
            ["#6272a4", "#6272a4"], # color 4 - Dracula dark blue - comment
            ["#8be9fd", "#8be9fd"], # color 5 - Dracula cyan
            ["#50fa7b", "#50fa7b"], # color 6 - Dracula green
            ["#ffb86c", "#ffb86c"], # color 7 - Dracula orange
            ["#ff79c6", "#ff79c6"], # color 8 - Dracula pink
            ["#bd93f9", "#bd93f9"], # color 9 - Dracula purple
            ["#ff5555", "#ff5555"], # color 10 - Dracula red
            ["#f1fa8c", "#f1fa8c"]] # color 11 - Dracula yellow
...
def init_screens():
    return [Screen(top=bar.Bar(widgets=init_widgets_screen1(),opacity = 1, size=26)),
            Screen(top=bar.Bar(widgets=init_widgets_screen2(),opacity = 1, size=26))]
